...
describe("Test parsing a data line", () => {
    test("Parse a data line", () => {
        ...
        expect(item.pointers[38]).toEqual({ symbol: 'Hyponym', pos: 'noun', offset:9477037 })
        ...
        item = new DataLine().parse('00089891 04 n 01 repossession 0 002 @ 00045907 n 0000 + 02205887 v 0102 | the action of regaining possession (especially the seizure of collateral securing a loan that is in default) ')
        ...
        expect(item.pointers[0]).toEqual({ symbol: 'Hypernym', pos: 'noun', offset: 45907 })
