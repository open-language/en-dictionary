...
describe("Test parsing a data line", () => {
    test("Parse a data line", () => {
        ...
        expect(item.pointers[38]).toEqual({ pointerSymbol: 'Hyponym', pos: 'noun', offset:9477037 })
        ...
        expect(item.pointers[0]).toEqual({ pointerSymbol: 'Hypernym', pos: 'noun', offset: 45907 })
