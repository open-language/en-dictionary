...
describe("Test parsing a data line", () => {
    test("Parse a data line", () => {
        ...
        expect(item.synsetOffset).toBe(2684)
        ...
        expect(item.pointers[38]).toEqual({ pointerSymbol: 'Hyponym', pos: 'noun', sourceTargetHex: '0000', synsetOffset:9477037 })
        ...
        expect(item.synsetOffset).toBe(89891)
        ...
        expect(item.pointers[0]).toEqual({ pointerSymbol: 'Hypernym', pos: 'noun', sourceTargetHex: '0000', synsetOffset: 45907 })
