...
describe("Test parsing a data line", () => {
    test("Parse a data line", () => {
        ...
        expect(item.pointers[38]).toEqual({ pointerSymbol: 'Hyponym', pos: 'noun', sourceTargetHex: '0000', offset:9477037 })
        ...
        expect(item.pointers[0]).toEqual({ pointerSymbol: 'Hypernym', pos: 'noun', sourceTargetHex: '0000', offset: 45907 })
